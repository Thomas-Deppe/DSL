...
// Engineer: s1924558
// 
// Create Date: 07.03.2023 09:46:56
// Design Name: 
// Module Name: Timer
// Project Name: Final_Processor
// Target Devices: xc7a35t (Basys 3 Board)
// Tool Versions: Vivado 2015.2
// Description: A timer module that generates an interrupt every 1ms. The machine code determine what happens
//              when a timer interrupt is called. 
// 
// Dependencies: 
// 
// Revision:
...
module Timer(
    ...
    parameter InitialIterruptRate = 100;
    //parameter InitialIterruptRate = 5;
    // By default the Interrupt is Enabled 
    parameter InitialIterruptEnable = 1'b1;     
    //////////////////////  
